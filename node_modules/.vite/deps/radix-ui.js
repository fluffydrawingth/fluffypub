import {
  require_react_dom
} from "./chunk-U4OSBCAA.js";
import {
  require_jsx_runtime
} from "./chunk-AXYHTZMO.js";
import {
  require_react
} from "./chunk-ZMV3MJRW.js";
import {
  __export,
  __privateAdd,
  __privateGet,
...
function createSlottable(ownerName) {
  const Slottable22 = __name2((props) => "child" in props ? props.children(props.child) : props.children, "Slottable");
...
var VisuallyHidden = React4.forwardRef(
  __name4(function VisuallyHidden2(props, forwardedRef) {
...
var AccessibleIcon = __name5(({ children, label }) => {
...
function createCollection(name) {
  ...
  const CollectionProvider = __name7((props) => {
  ...
  __name7(useCollection10, "useCollection");
  return [
...
__name7(createCollection, "createCollection");
...
}, _keys = new WeakMap(), __name7(_a, "OrderedDict"), _a);
...
__name7(toSafeIndex, "toSafeIndex");
function toSafeInteger(number) {
  return number !== number || number === 0 ? 0 : Math.trunc(number);
}
__name7(toSafeInteger, "toSafeInteger");
function createCollection2(name) {
  ...
  const CollectionProviderImpl = __name7((props) => {
  ...
  __name7(useInitCollection2, "useInitCollection");
  function useCollection10(scope) {
...
__name7(createCollection2, "createCollection");
...
__name7(isElementPreceding, "isElementPreceding");
function sortByDocumentPosition(a, b) {
  return !a[1].element || !b[1].element ? 0 : isElementPreceding(a[1].element, b[1].element) ? -1 : 1;
}
__name7(sortByDocumentPosition, "sortByDocumentPosition");
...
function composeEventHandlers(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
  return __name8(function handleEvent(event) {
...
__name8(composeEventHandlers, "composeEventHandlers");
...
__name8(getOwnerWindow, "getOwnerWindow");
...
__name8(getOwnerDocument, "getOwnerDocument");
...
__name8(getActiveElement, "getActiveElement");
function isFrame(element) {
  return element.tagName === "IFRAME";
}
__name8(isFrame, "isFrame");
...
__name11(getElementRef2, "getElementRef");
...
var Collapsible = React13.forwardRef(
  __name13(function Collapsible2(props, forwardedRef) {
    const {
      __scopeCollapsible,
      open: openProp,
      defaultOpen,
...
var CollapsibleTrigger = React13.forwardRef(
  ...
  __name13(function CollapsibleTrigger2(props, forwardedRef) {
...
var CollapsibleContent = React13.forwardRef(
  // blank line to reduce diff noise
  __name13(function CollapsibleContent2(props, forwardedRef) {
...
var CollapsibleContentImpl = React13.forwardRef(__name13(function CollapsibleContentImpl2(props, forwardedRef) {
...
var DirectionProvider = __name14((props) => {
...
__name14(useDirection, "useDirection");
...
var Accordion = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function Accordion2(props, forwardedRef) {
...
var AccordionImplSingle = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function AccordionImplSingle2(props, forwardedRef) {
    const {
      value: valueProp,
      defaultValue,
      onValueChange = __name15(() => {
      }, "onValueChange"),
      collapsible = false,
...
var AccordionImplMultiple = React15.forwardRef(__name15(function AccordionImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name15(() => {
...
var AccordionImpl = React15.forwardRef(
  __name15(function AccordionImpl2(props, forwardedRef) {
    ...
    const handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
      ...
      const moveNext = __name15(() => {
        nextIndex = triggerIndex + 1;
        if (nextIndex > endIndex) {
          nextIndex = homeIndex;
        }
      }, "moveNext");
      const movePrev = __name15(() => {
        nextIndex = triggerIndex - 1;
...
var AccordionItem = React15.forwardRef(
  __name15(function AccordionItem2(props, forwardedRef) {
...
var AccordionHeader = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function AccordionHeader2(props, forwardedRef) {
...
var AccordionTrigger = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function AccordionTrigger2(props, forwardedRef) {
...
var AccordionContent = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function AccordionContent2(props, forwardedRef) {
...
__name16(useCallbackRef, "useCallbackRef");
...
var DismissableLayer = React17.forwardRef(
  // blank line to reduce diff noise
  __name17(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    const isDeferredPointerDownOutsideRef = React17.useRef(false);
    const pointerDownOutside = usePointerDownOutside(
      ...
      },
      {
        ...
        shouldHandlePointerDownOutside: React17.useCallback(
          (target) => {
    ...
    React17.useEffect(() => {
      const handleUpdate = __name17(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React17.forwardRef(__name17(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React17.useContext(DismissableLayerContext);
...
__name17(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = __name17(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  const isPointerDownOutsideRef = React17.useRef(false);
  const interceptedOutsideInteractionEventsRef = React17.useRef(/* @__PURE__ */ new Map());
  ...
  React17.useEffect(() => {
    ...
    __name17(resetOutsideInteraction, "resetOutsideInteraction");
    function isOutsideInteractionIntercepted() {
      return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
    }
    __name17(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
    ...
    __name17(handleInteractionCapture, "handleInteractionCapture");
    function handleInteractionBubble(event) {
      if (isPointerDownOutsideRef.current) {
        interceptedOutsideInteractionEventsRef.current.set(event.type, false);
      }
    }
    __name17(handleInteractionBubble, "handleInteractionBubble");
    const handlePointerDown = __name17((event) => {
      if (event.target && !isPointerInsideReactTreeRef.current) {
        ...
        __name17(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
  ...
  return {
    ...
    onPointerDownCapture: __name17(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
__name17(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  const handleFocusOutside = useCallbackRef(onFocusOutside);
  const isFocusInsideReactTreeRef = React17.useRef(false);
  React17.useEffect(() => {
    const handleFocus = __name17((event) => {
  ...
  return {
    onFocusCapture: __name17(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name17(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
__name17(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
  const event = new CustomEvent(CONTEXT_UPDATE);
  document.dispatchEvent(event);
}
__name17(dispatchUpdate, "dispatchUpdate");
...
__name17(handleAndDispatchCustomEvent, "handleAndDispatchCustomEvent");
...
var FocusScope = React18.forwardRef(
  __name18(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
    ...
    React18.useEffect(() => {
      if (trapped) {
        ...
        __name18(handleFocusIn2, "handleFocusIn");
        __name18(handleFocusOut2, "handleFocusOut");
        __name18(handleMutations2, "handleMutations");
...
__name18(focusFirst, "focusFirst");
...
__name18(getTabbableEdges, "getTabbableEdges");
function getTabbableCandidates(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name18((node) => {
...
__name18(getTabbableCandidates, "getTabbableCandidates");
...
__name18(findVisible, "findVisible");
...
__name18(isHidden, "isHidden");
function isSelectableInput(element) {
  return element instanceof HTMLInputElement && "select" in element;
}
__name18(isSelectableInput, "isSelectableInput");
...
__name18(createFocusScopesStack, "createFocusScopesStack");
...
__name18(arrayRemove, "arrayRemove");
function removeLinks(items) {
  return items.filter((item) => item.tagName !== "A");
}
__name18(removeLinks, "removeLinks");
...
var __name19 = (target, value) => __defProp19(target, "name", { value, configurable: true });
var Portal = React19.forwardRef(
  __name19(function Portal2(props, forwardedRef) {
    var _a2;
...
var __name20 = (target, value) => __defProp20(target, "name", { value, configurable: true });
var count2 = 0;
var guards = null;
...
__name20(FocusGuards, "FocusGuards");
...
__name20(useFocusGuards, "useFocusGuards");
...
__name20(createFocusGuard, "createFocusGuard");
...
var DialogTrigger = React33.forwardRef(
  __name21(function DialogTrigger2(props, forwardedRef) {
...
var DialogPortal = __name21((props) => {
  const { __scopeDialog, forceMount, children, container } = props;
  const context = useDialogContext(PORTAL_NAME, __scopeDialog);
  return (0, import_jsx_runtime13.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React33.Children.map(children, (child) => (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Portal, { asChild: true, container, children: child }) })) });
}, "DialogPortal");
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React33.forwardRef(
  __name21(function DialogOverlay2(props, forwardedRef) {
...
var DialogOverlayImpl = React33.forwardRef(
  // blank line to reduce diff noise
  __name21(function DialogOverlayImpl2(props, forwardedRef) {
...
var DialogContent = React33.forwardRef(
  __name21(function DialogContent2(props, forwardedRef) {
...
var DialogContentModal = React33.forwardRef(
  // blank line to reduce diff noise
  __name21(function DialogContentModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME3, props.__scopeDialog);
    const contentRef = React33.useRef(null);
...
var DialogContentNonModal = React33.forwardRef(
  // blank line to reduce diff noise
  __name21(function DialogContentNonModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME3, props.__scopeDialog);
...
var DialogContentImpl = React33.forwardRef(
  // blank line to reduce diff noise
  __name21(function DialogContentImpl2(props, forwardedRef) {
...
var DialogTitle = React33.forwardRef(
  __name21(function DialogTitle2(props, forwardedRef) {
...
var DialogDescription = React33.forwardRef(
  // blank line to reduce diff noise
  __name21(function DialogDescription2(props, forwardedRef) {
...
var DialogClose = React33.forwardRef(
  __name21(function DialogClose2(props, forwardedRef) {
...
var WarningProvider = __name21((props) => {
  return props.children;
}, "WarningProvider");
function getState3(open) {
  return open ? "open" : "closed";
}
__name21(getState3, "getState");
...
var AlertDialogContent = React34.forwardRef(
  __name22(function AlertDialogContent2(props, forwardedRef) {
    const { __scopeAlertDialog, children, ...contentProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const contentRef = React34.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const cancelRef = React34.useRef(null);
...
var AlertDialogTitle = React34.forwardRef(
  __name22(function AlertDialogTitle2(props, forwardedRef) {
    const { __scopeAlertDialog, ...titleProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime14.jsx)(DialogTitle, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }, "AlertDialogTitle")
);
var AlertDialogDescription = React34.forwardRef(__name22(function AlertDialogDescription2(props, forwardedRef) {
  const { __scopeAlertDialog, ...descriptionProps } = props;
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime14.jsx)(DialogDescription, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
}, "AlertDialogDescription"));
var AlertDialogAction = React34.forwardRef(
  __name22(function AlertDialogAction2(props, forwardedRef) {
...
var AlertDialogCancel = React34.forwardRef(
  __name22(function AlertDialogCancel2(props, forwardedRef) {
...
var AspectRatio = React35.forwardRef(
  __name23(function AspectRatio2(props, forwardedRef) {
...
var Avatar = React36.forwardRef(
  // blank line to reduce diff noise
  __name24(function Avatar2(props, forwardedRef) {
...
var AvatarImage = React36.forwardRef(
  __name24(function AvatarImage2(props, forwardedRef) {
    ...
    const loadingStatusRef = React36.useRef(imageLoadingStatus);
    useLayoutEffect2(() => {
...
var AvatarFallback = React36.forwardRef(
  __name24(function AvatarFallback2(props, forwardedRef) {
...
function useImageLoadingStatus(src, {
  ...
  useLayoutEffect2(() => {
    ...
    const handleLoad = __name24((event) => {
      const image2 = event.currentTarget;
      setLoadingStatus(getImageLoadingStatus(image2));
    }, "handleLoad");
    const handleError = __name24(() => setLoadingStatus("error"), "handleError");
...
__name24(useImageCount, "useImageCount");
...
__name24(useUpdateImageCount, "useUpdateImageCount");
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React38.useState(null);
  const [bubbleInput, setBubbleInput] = React38.useState(null);
  const hasConsumerStoppedPropagationRef = React38.useRef(false);
  const [userInteractionCount, onUserInteraction] = React38.useReducer(
    (count3) => count3 + 1,
    0
  );
...
__name26(CheckboxProvider, "CheckboxProvider");
var TRIGGER_NAME4 = "CheckboxTrigger";
var CheckboxTrigger = React38.forwardRef(
  __name26(function CheckboxTrigger2({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) {
    const {
      control,
      value,
      disabled,
    ...
    const initialCheckedStateRef = React38.useRef(checked);
    React38.useEffect(() => {
      const form = control == null ? void 0 : control.form;
      if (form) {
        const reset = __name26(() => setChecked(initialCheckedStateRef.current), "reset");
...
var Checkbox = React38.forwardRef(
  // blank line to reduce diff noise
  __name26(function Checkbox2(props, forwardedRef) {
    const {
      __scopeCheckbox,
      name,
      checked,
...
var CheckboxIndicator = React38.forwardRef(
  // blank line to reduce diff noise
  __name26(function CheckboxIndicator2(props, forwardedRef) {
...
var CheckboxBubbleInput = React38.forwardRef(
  // blank line to reduce diff noise
  __name26(function CheckboxBubbleInput2({ __scopeCheckbox, onClick, ...props }, forwardedRef) {
    const {
      control,
      hasConsumerStoppedPropagationRef,
      userInteractionCount,
    ...
    const shouldStopClickPropagationRef = React38.useRef(false);
    const prevCheckedRef = React38.useRef(checked);
    const prevUserInteractionCountRef = React38.useRef(userInteractionCount);
    React38.useEffect(() => {
    ...
    const defaultCheckedRef = React38.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime17.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
__name26(isFunction2, "isFunction");
...
var Arrow = React40.forwardRef(
  __name27(function Arrow2(props, forwardedRef) {
...
var Popper = __name28((props) => {
  const { __scopePopper, children } = props;
  const [anchor, setAnchor] = React41.useState(null);
  const [placementState, setPlacementState] = React41.useState(void 0);
...
var PopperAnchor = React41.forwardRef(
  __name28(function PopperAnchor2(props, forwardedRef) {
    const { __scopePopper, virtualRef, ...anchorProps } = props;
    const context = usePopperContext(ANCHOR_NAME, __scopePopper);
    const ref = React41.useRef(null);
    const onAnchorChange = context.onAnchorChange;
    const callbackRef = React41.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
    ...
    const anchorRef = React41.useRef(null);
    React41.useEffect(() => {
      if (!virtualRef) {
        return;
      }
...
var PopperContent = React41.forwardRef(
  __name28(function PopperContent2(props, forwardedRef) {
    ...
    const [arrow4, setArrow] = React41.useState(null);
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name28((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name28(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React41.forwardRef(
  __name28(function PopperArrow2(props, forwardedRef) {
...
__name28(isNotNull, "isNotNull");
var transformOrigin = __name28((options) => ({
...
__name28(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root25 = Popper;
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React42.useState(_isHydrated);
  React42.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name29(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React43.forwardRef(__name30(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name30(getDirectionAwareKey, "getDirectionAwareKey");
...
__name30(getFocusIntent, "getFocusIntent");
...
__name30(focusFirst2, "focusFirst");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name30(wrapArray, "wrapArray");
...
var __name31 = (target, value) => __defProp31(target, "name", { value, configurable: true });
...
var Menu = __name31((props) => {
  ...
  const direction = useDirection(dir);
  React44.useEffect(() => {
    const handleKeyDown = __name31(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name31(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React44.useEffect(() => {
    ...
    const handleBlur = __name31(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React44.forwardRef(
  __name31(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React44.forwardRef(
  __name31(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
...
var MenuRootContentNonModal = React44.forwardRef(__name31(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
  return (0, import_jsx_runtime21.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name31((key) => {
      var _a2, _b;
      ...
      __name31(function updateSearch(value) {
...
var MenuGroup = React44.forwardRef(
  __name31(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React44.forwardRef(
  __name31(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React44.forwardRef(
  __name31(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name31(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React44.forwardRef(
  __name31(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React44.forwardRef(
  __name31(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React44.forwardRef(
  __name31(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React44.forwardRef(
  __name31(function MenuArrow2(props, forwardedRef) {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime21.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "MenuArrow")
);
var SUB_NAME = "MenuSub";
var [MenuSubProvider, useMenuSubContext] = createMenuContext(SUB_NAME);
var MenuSub = __name31((props) => {
...
var MenuSubTrigger = React44.forwardRef(
  __name31(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React44.forwardRef(
  __name31(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext2(CONTENT_NAME6, props.__scopeMenu);
...
__name31(getOpenState, "getOpenState");
function isIndeterminate2(checked) {
  return checked === "indeterminate";
}
__name31(isIndeterminate2, "isIndeterminate");
function getCheckedState(checked) {
  return isIndeterminate2(checked) ? "indeterminate" : checked ? "checked" : "unchecked";
}
__name31(getCheckedState, "getCheckedState");
...
__name31(focusFirst3, "focusFirst");
function wrapArray2(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name31(wrapArray2, "wrapArray");
...
__name31(getNextMatch, "getNextMatch");
...
__name31(isPointInPolygon, "isPointInPolygon");
function isPointerInGraceArea(event, area) {
  if (!area) return false;
  const cursorPos = { x: event.clientX, y: event.clientY };
  return isPointInPolygon(cursorPos, area);
}
__name31(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name31(whenMouse, "whenMouse");
var Root32 = Menu;
...
var __name32 = (target, value) => __defProp32(target, "name", { value, configurable: true });
...
var ContextMenu = __name32((props) => {
  const { __scopeContextMenu, children, onOpenChange, open: openProp, dir, modal = true } = props;
  const hasInteractedRef = React45.useRef(false);
  if (IS_DEVELOPMENT) {
    const hasWarnedRef = React45.useRef(false);
    React45.useEffect(() => {
...
var ContextMenuTrigger = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function ContextMenuTrigger2(props, forwardedRef) {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME5, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const [point, setPoint] = React45.useState({ x: 0, y: 0 });
    const virtualRef = React45.useMemo(
      () => ({
        current: {
          getBoundingClientRect: __name32(() => DOMRect.fromRect({ width: 0, height: 0, ...point }), "getBoundingClientRect")
        }
      }),
      [point]
    );
    ...
    const handleOpen = __name32((event) => {
...
var ContextMenuPortal = __name32((props) => {
...
var ContextMenuContent = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function ContextMenuContent2(props, forwardedRef) {
...
var ContextMenuGroup = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function ContextMenuGroup2(props, forwardedRef) {
...
var ContextMenuLabel = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function ContextMenuLabel2(props, forwardedRef) {
...
var ContextMenuItem = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function ContextMenuItem2(props, forwardedRef) {
    const { __scopeContextMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime22.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "ContextMenuItem")
);
var ContextMenuCheckboxItem = React45.forwardRef(__name32(function ContextMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeContextMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime22.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "ContextMenuCheckboxItem"));
var ContextMenuRadioGroup = React45.forwardRef(__name32(function ContextMenuRadioGroup2(props, forwardedRef) {
  const { __scopeContextMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime22.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "ContextMenuRadioGroup"));
var ContextMenuRadioItem = React45.forwardRef(__name32(function ContextMenuRadioItem2(props, forwardedRef) {
  const { __scopeContextMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime22.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "ContextMenuRadioItem"));
var ContextMenuItemIndicator = React45.forwardRef(__name32(function ContextMenuItemIndicator2(props, forwardedRef) {
  const { __scopeContextMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime22.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "ContextMenuItemIndicator"));
var ContextMenuSeparator = React45.forwardRef(__name32(function ContextMenuSeparator2(props, forwardedRef) {
...
var ContextMenuArrow = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function ContextMenuArrow2(props, forwardedRef) {
...
var ContextMenuSub = __name32((props) => {
...
var ContextMenuSubTrigger = React45.forwardRef(__name32(function ContextMenuSubTrigger2(props, forwardedRef) {
  const { __scopeContextMenu, ...triggerItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime22.jsx)(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
}, "ContextMenuSubTrigger"));
var ContextMenuSubContent = React45.forwardRef(__name32(function ContextMenuSubContent2(props, forwardedRef) {
...
__name32(whenTouchOrPen, "whenTouchOrPen");
...
var __name33 = (target, value) => __defProp33(target, "name", { value, configurable: true });
...
var DropdownMenu = __name33((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name33((props) => {
...
var DropdownMenuContent = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime23.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React46.forwardRef(__name33(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime23.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React46.forwardRef(__name33(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime23.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React46.forwardRef(__name33(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime23.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React46.forwardRef(__name33(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime23.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React46.forwardRef(__name33(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime23.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name33((props) => {
...
var DropdownMenuSubTrigger = React46.forwardRef(__name33(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime23.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React46.forwardRef(__name33(function DropdownMenuSubContent2(props, forwardedRef) {
...
var __name34 = (target, value) => __defProp34(target, "name", { value, configurable: true });
var Label3 = React47.forwardRef(
  __name34(function Label23(props, forwardedRef) {
...
var __name35 = (target, value) => __defProp35(target, "name", { value, configurable: true });
...
var Form = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function Form2(props, forwardedRef) {
    const { __scopeForm, onClearServerErrors = __name35(() => {
...
var FormField = React48.forwardRef(
  __name35(function FormField2(props, forwardedRef) {
...
var FormLabel = React48.forwardRef(
  __name35(function FormLabel2(props, forwardedRef) {
    ...
    const name = nameProp ?? (fieldContext == null ? void 0 : fieldContext.name);
    if (!name) {
      throw new Error(
        `\`${LABEL_NAME}\` must be used within \`${FIELD_NAME}\` or specify the \`name\` prop`
      );
    }
    const htmlFor = labelProps.htmlFor || (fieldContext == null ? void 0 : fieldContext.id);
    if (!htmlFor) {
      throw new Error(
    ...
    const validity = validationContext.getFieldValidity(name);
    const serverInvalid = (fieldContext == null ? void 0 : fieldContext.serverInvalid) ?? false;
    return (0, import_jsx_runtime25.jsx)(
      Label3,
      {
        "data-valid": getValidAttribute(validity, serverInvalid),
...
var FormControl = React48.forwardRef(
  __name35(function FormControl2(props, forwardedRef) {
    ...
    const id = idProp || (fieldContext == null ? void 0 : fieldContext.id);
    if (!id) {
      throw new Error(
    ...
    React48.useEffect(() => {
      ...
      if (control) {
        const handleChange = __name35(() => updateControlValidity(control), "handleChange");
    ...
    React48.useEffect(() => {
      ...
      if (firstInvalidControl === control) {
        firstInvalidControl == null ? void 0 : firstInvalidControl.focus();
      }
    }, [serverInvalid]);
    const validity = validationContext.getFieldValidity(name);
    return (0, import_jsx_runtime25.jsx)(
...
var FormMessage = React48.forwardRef(
  __name35(function FormMessage2(props, forwardedRef) {
...
var FormBuiltInMessage = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function FormBuiltInMessage2(props, forwardedRef) {
...
var FormCustomMessage = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function FormCustomMessage2(props, forwardedRef) {
...
var FormMessageImpl = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function FormMessageImpl2(props, forwardedRef) {
...
var FormValidityState = __name35((props) => {
...
var FormSubmit = React48.forwardRef(
  __name35(function FormSubmit2(props, forwardedRef) {
...
__name35(validityStateToObject, "validityStateToObject");
function isHTMLElement2(element) {
  return element instanceof HTMLElement;
}
__name35(isHTMLElement2, "isHTMLElement");
function isFormControl(element) {
  return "validity" in element;
}
__name35(isFormControl, "isFormControl");
...
__name35(getFirstInvalidControl, "getFirstInvalidControl");
function isAsyncCustomMatcherEntry(entry, args) {
  return entry.match.constructor.name === "AsyncFunction" || returnsPromise(entry.match, args);
}
__name35(isAsyncCustomMatcherEntry, "isAsyncCustomMatcherEntry");
function isSyncCustomMatcherEntry(entry) {
  return entry.match.constructor.name === "Function";
}
__name35(isSyncCustomMatcherEntry, "isSyncCustomMatcherEntry");
function returnsPromise(func, args) {
  return func(...args) instanceof Promise;
}
__name35(returnsPromise, "returnsPromise");
...
__name35(getInvalidAttribute, "getInvalidAttribute");
var Root10 = Form;
var Field = FormField;
...
var __name36 = (target, value) => __defProp36(target, "name", { value, configurable: true });
...
var HoverCardTrigger = React49.forwardRef(
  // blank line to reduce diff noise
  __name36(function HoverCardTrigger2(props, forwardedRef) {
...
var [PortalProvider3, usePortalContext3] = createHoverCardContext(PORTAL_NAME3, {
  forceMount: void 0
});
var HoverCardPortal = __name36((props) => {
...
var HoverCardContent = React49.forwardRef(
  // blank line to reduce diff noise
  __name36(function HoverCardContent2(props, forwardedRef) {
...
var HoverCardContentImpl = React49.forwardRef(__name36(function HoverCardContentImpl2(props, forwardedRef) {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  React49.useEffect(() => {
    if (ref.current) {
      const handlePointerUp = __name36(() => {
...
var HoverCardArrow = React49.forwardRef(
  __name36(function HoverCardArrow2(props, forwardedRef) {
    const { __scopeHoverCard, ...arrowProps } = props;
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime26.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "HoverCardArrow")
);
function excludeTouch(eventHandler) {
  return (event) => event.pointerType === "touch" ? void 0 : eventHandler();
}
__name36(excludeTouch, "excludeTouch");
function getTabbableNodes(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name36((node) => {
      return node.tabIndex >= 0 ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
    }, "acceptNode")
  });
  while (walker.nextNode()) nodes.push(walker.currentNode);
...
__name36(getTabbableNodes, "getTabbableNodes");
...
var __name37 = (target, value) => __defProp37(target, "name", { value, configurable: true });
...
var Menubar = React50.forwardRef(
  // blank line to reduce diff noise
  __name37(function Menubar2(props, forwardedRef) {
    const {
      __scopeMenubar,
      value: valueProp,
      onValueChange,
...
var MenubarMenu = __name37((props) => {
...
var MenubarTrigger = React50.forwardRef(
  __name37(function MenubarTrigger2(props, forwardedRef) {
...
var MenubarPortal = __name37((props) => {
...
var MenubarContent = React50.forwardRef(
  __name37(function MenubarContent2(props, forwardedRef) {
...
var MenubarGroup = React50.forwardRef(
  __name37(function MenubarGroup2(props, forwardedRef) {
...
var MenubarLabel = React50.forwardRef(
  __name37(function MenubarLabel2(props, forwardedRef) {
...
var MenubarItem = React50.forwardRef(
  __name37(function MenubarItem2(props, forwardedRef) {
...
var MenubarCheckboxItem = React50.forwardRef(
  // blank line to reduce diff noise
  __name37(function MenubarCheckboxItem2(props, forwardedRef) {
...
var MenubarRadioGroup = React50.forwardRef(
  // blank line to reduce diff noise
  __name37(function MenubarRadioGroup2(props, forwardedRef) {
...
var MenubarRadioItem = React50.forwardRef(
  // blank line to reduce diff noise
  __name37(function MenubarRadioItem2(props, forwardedRef) {
    const { __scopeMenubar, ...radioItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime27.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
  }, "MenubarRadioItem")
);
var MenubarItemIndicator = React50.forwardRef(__name37(function MenubarItemIndicator2(props, forwardedRef) {
...
var MenubarSeparator = React50.forwardRef(
  // blank line to reduce diff noise
  __name37(function MenubarSeparator2(props, forwardedRef) {
...
var MenubarArrow = React50.forwardRef(
  __name37(function MenubarArrow2(props, forwardedRef) {
...
var MenubarSubTrigger = React50.forwardRef(
  // blank line to reduce diff noise
  __name37(function MenubarSubTrigger2(props, forwardedRef) {
...
var MenubarSubContent = React50.forwardRef(
  // blank line to reduce diff noise
  __name37(function MenubarSubContent2(props, forwardedRef) {
...
var __name38 = (target, value) => __defProp38(target, "name", { value, configurable: true });
...
__name38(usePrevious, "usePrevious");

// node_modules/@radix-ui/react-navigation-menu/dist/index.mjs
var import_jsx_runtime28 = __toESM(require_jsx_runtime(), 1);
var __defProp39 = Object.defineProperty;
var __name39 = (target, value) => __defProp39(target, "name", { value, configurable: true });
...
var NavigationMenu = React52.forwardRef(
  __name39(function NavigationMenu2(props, forwardedRef) {
    const {
...
var NavigationMenuSub = React52.forwardRef(
  // blank line to reduce diff noise
  __name39(function NavigationMenuSub2(props, forwardedRef) {
    const {
      __scopeNavigationMenu,
      value: valueProp,
      onValueChange,
...
var NavigationMenuProvider = __name39((props) => {
  const {
    scope,
    isRootMenu,
    rootNavigationMenu,
...
var NavigationMenuList = React52.forwardRef(
  // blank line to reduce diff noise
  __name39(function NavigationMenuList2(props, forwardedRef) {
...
var NavigationMenuItem = React52.forwardRef(
  // blank line to reduce diff noise
  __name39(function NavigationMenuItem2(props, forwardedRef) {
...
var NavigationMenuTrigger = React52.forwardRef(__name39(function NavigationMenuTrigger2(props, forwardedRef) {
...
var NavigationMenuLink = React52.forwardRef(
  // blank line to reduce diff noise
  __name39(function NavigationMenuLink2(props, forwardedRef) {
...
var NavigationMenuIndicator = React52.forwardRef(__name39(function NavigationMenuIndicator2(props, forwardedRef) {
...
var NavigationMenuIndicatorImpl = React52.forwardRef(__name39(function NavigationMenuIndicatorImpl2(props, forwardedRef) {
  ...
  const handlePositionChange = __name39(() => {
    if (activeTrigger) {
      setPosition({
...
var NavigationMenuContent = React52.forwardRef(__name39(function NavigationMenuContent2(props, forwardedRef) {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React52.forwardRef(__name39(function ViewportContentMounter2(props, forwardedRef) {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React52.forwardRef(__name39(function NavigationMenuContentImpl2(props, forwardedRef) {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
...
var NavigationMenuViewport = React52.forwardRef(__name39(function NavigationMenuViewport2(props, forwardedRef) {
...
var NavigationMenuViewportImpl = React52.forwardRef(__name39(function NavigationMenuViewportImpl2(props, forwardedRef) {
  ...
  const handleSizeChange = __name39(() => {
...
var NavigationMenuViewportItem = __name39(({
  contentRef,
  isActive,
  onActiveContentChange,
  ...props
}) => {
  const handleContentChange = React52.useCallback(
    (node) => {
      if (isActive && node) {
  ...
  return (0, import_jsx_runtime28.jsx)(NavigationMenuContentImpl, { ...props, ref: composedRefs });
}, "NavigationMenuViewportItem");
var FOCUS_GROUP_NAME = "FocusGroup";
var FocusGroup = React52.forwardRef(
  __name39(function FocusGroup2(props, forwardedRef) {
...
var FocusGroupItem = React52.forwardRef(
  __name39(function FocusGroupItem2(props, forwardedRef) {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
__name39(getTabbableCandidates2, "getTabbableCandidates");
...
__name39(focusFirst4, "focusFirst");
...
__name39(removeFromTabOrder, "removeFromTabOrder");
...
__name39(useResizeObserver, "useResizeObserver");
function getOpenState2(open) {
  return open ? "open" : "closed";
}
__name39(getOpenState2, "getOpenState");
function makeTriggerId(baseId, value) {
  return `${baseId}-trigger-${value}`;
}
__name39(makeTriggerId, "makeTriggerId");
function makeContentId(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name39(makeContentId, "makeContentId");
function whenMouse2(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name39(whenMouse2, "whenMouse");
...
var __name40 = (target, value) => __defProp40(target, "name", { value, configurable: true });
function clamp2(value, [min2, max2]) {
  return Math.min(max2, Math.max(min2, value));
}
__name40(clamp2, "clamp");

// node_modules/@radix-ui/react-one-time-password-field/dist/index.mjs
var import_jsx_runtime29 = __toESM(require_jsx_runtime(), 1);
var __defProp41 = Object.defineProperty;
var __name41 = (target, value) => __defProp41(target, "name", { value, configurable: true });
...
var OneTimePasswordField = React53.forwardRef(
  // blank line to reduce diff noise
  __name41(function OneTimePasswordFieldImpl({
    ...
    const latestValueRef = React53.useRef(value);
    latestValueRef.current = value;
    const dispatch = React53.useCallback(
      (action) => {
    ...
    React53.useEffect(() => {
      ...
      if (form2) {
        const reset = __name41(() => dispatch({ type: "CLEAR", reason: "Reset" }), "reset");
...
var OneTimePasswordFieldHiddenInput = React53.forwardRef(__name41(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React53.forwardRef(__name41(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
...
__name41(isFormElement, "isFormElement");
function removeWhitespace(value) {
  return value.replace(/\s/g, "");
}
__name41(removeWhitespace, "removeWhitespace");
...
__name41(focusInput, "focusInput");
function isInputEvent(event) {
  return event.type === "input";
}
__name41(isInputEvent, "isInputEvent");
...
var __name42 = (target, value) => __defProp42(target, "name", { value, configurable: true });
...
var PasswordToggleField = __name42(({
...
var PasswordToggleFieldInput = React54.forwardRef(
  // blank line to reduce diff noise
  __name42(function PasswordToggleFieldInput2({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React54.forwardRef(
  // blank line to reduce diff noise
  __name42(function PasswordToggleFieldToggle2({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    onPointerCancel,
    ...
    React54.useEffect(() => {
      ...
      __name42(checkForInnerTextLabel, "checkForInnerTextLabel");
    ...
    React54.useEffect(() => {
      var _a2, _b;
      let cleanup = __name42(() => {
      }, "cleanup");
      const ownerWindow = ((_b = (_a2 = elementRef.current) == null ? void 0 : _a2.ownerDocument) == null ? void 0 : _b.defaultView) || window;
      const reset = __name42(() => focusState.current.clickTriggered = false, "reset");
      const handlePointerUp = __name42(() => cleanup = requestIdleCallback(ownerWindow, reset), "handlePointerUp");
...
var PasswordToggleFieldSlot = __name42(({
  __scopePasswordToggleField,
  ...props
}) => {
...
var PasswordToggleFieldIcon = React54.forwardRef(
  // blank line to reduce diff noise
  __name42(function PasswordToggleFieldIcon2({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...props
...
function requestIdleCallback(window2, callback, options) {
  ...
  const id = window2.setTimeout(() => {
    const timeRemaining = __name42(() => Math.max(0, 50 - (Date.now() - start)), "timeRemaining");
...
__name42(requestIdleCallback, "requestIdleCallback");
...
var __name43 = (target, value) => __defProp43(target, "name", { value, configurable: true });
...
var PopoverAnchor = React55.forwardRef(
  __name43(function PopoverAnchor2(props, forwardedRef) {
...
var PopoverTrigger = React55.forwardRef(
  __name43(function PopoverTrigger2(props, forwardedRef) {
...
var [PortalProvider4, usePortalContext4] = createPopoverContext(PORTAL_NAME4, {
  forceMount: void 0
});
var PopoverPortal = __name43((props) => {
...
var PopoverContent = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function PopoverContent2(props, forwardedRef) {
...
var PopoverContentModal = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function PopoverContentModal2(props, forwardedRef) {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
...
var PopoverContentNonModal = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function PopoverContentNonModal2(props, forwardedRef) {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
...
var PopoverContentImpl = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function PopoverContentImpl2(props, forwardedRef) {
    const {
      __scopePopover,
      trapFocus,
      onOpenAutoFocus,
...
var PopoverClose = React55.forwardRef(
  __name43(function PopoverClose2(props, forwardedRef) {
...
var PopoverArrow = React55.forwardRef(
  __name43(function PopoverArrow2(props, forwardedRef) {
    const { __scopePopover, ...arrowProps } = props;
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime31.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "PopoverArrow")
);
function getState5(open) {
  return open ? "open" : "closed";
}
__name43(getState5, "getState");
var Root210 = Popover;
...
var __name44 = (target, value) => __defProp44(target, "name", { value, configurable: true });
...
var Progress = React56.forwardRef(
  // blank line to reduce diff noise
  __name44(function Progress2(props, forwardedRef) {
    const {
      __scopeProgress,
...
var ProgressIndicator = React56.forwardRef(
  // blank line to reduce diff noise
  __name44(function ProgressIndicator2(props, forwardedRef) {
...
__name44(defaultGetValueLabel, "defaultGetValueLabel");
function getProgressState(value, maxValue) {
  return value == null ? "indeterminate" : value === maxValue ? "complete" : "loading";
}
__name44(getProgressState, "getProgressState");
function isNumber(value) {
  return typeof value === "number";
}
__name44(isNumber, "isNumber");
function isValidMaxNumber(max2) {
  return isNumber(max2) && !isNaN(max2) && max2 > 0;
}
__name44(isValidMaxNumber, "isValidMaxNumber");
function isValidValueNumber(value, max2) {
  return isNumber(value) && !isNaN(value) && value <= max2 && value >= 0;
}
__name44(isValidValueNumber, "isValidValueNumber");
function getInvalidMaxError(propValue, componentName) {
  return `Invalid prop \`max\` of value \`${propValue}\` supplied to \`${componentName}\`. Only numbers greater than 0 are valid max values. Defaulting to \`${DEFAULT_MAX}\`.`;
}
__name44(getInvalidMaxError, "getInvalidMaxError");
...
__name44(getInvalidValueError, "getInvalidValueError");
var Root11 = Progress;
...
var __name45 = (target, value) => __defProp45(target, "name", { value, configurable: true });
...
function RadioProvider(props) {
  ...
  const context = {
    ...
    bubbleInput,
    setBubbleInput,
    onCheck: __name45(() => onCheck == null ? void 0 : onCheck(), "onCheck")
  };
...
__name45(RadioProvider, "RadioProvider");
var TRIGGER_NAME11 = "RadioTrigger";
var RadioTrigger = React57.forwardRef(
  __name45(function RadioTrigger2({ __scopeRadio, onClick, ...radioProps }, forwardedRef) {
    const {
      checked,
      disabled,
      value,
...
var RadioIndicator = React57.forwardRef(
  __name45(function RadioIndicator2(props, forwardedRef) {
...
var RadioBubbleInput = React57.forwardRef(
  __name45(function RadioBubbleInput2({ __scopeRadio, onClick, ...props }, forwardedRef) {
    const {
      control,
      checked,
      required,
    ...
    const composedRefs = useComposedRefs(forwardedRef, setBubbleInput);
    const controlSize = useSize(control);
    const shouldStopClickPropagationRef = React57.useRef(false);
    const prevCheckedRef = React57.useRef(checked);
    const prevUserInteractionCountRef = React57.useRef(userInteractionCount);
    React57.useEffect(() => {
      const input = bubbleInput;
      if (!input) return;
      const inputProto = window.HTMLInputElement.prototype;
    ...
    const defaultCheckedRef = React57.useRef(checked);
    return (0, import_jsx_runtime33.jsx)(
      Primitive.input,
      {
        type: "radio",
...
__name45(isFunction3, "isFunction");
function getState6(checked) {
  return checked ? "checked" : "unchecked";
}
__name45(getState6, "getState");
...
var RadioGroup3 = React211.forwardRef(
  __name45(function RadioGroup24(props, forwardedRef) {
    const {
      __scopeRadioGroup,
      name,
      form,
    ...
    const [value, setValue] = useControllableState({
      ...
      onChange: onValueChange,
      caller: RADIO_GROUP_NAME2
    });
    const [control, setControl] = React211.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, setControl);
    const initialValueRef = React211.useRef(value);
    React211.useEffect(() => {
      ...
      if (associatedForm instanceof HTMLFormElement) {
        const reset = __name45(() => setValue(initialValueRef.current), "reset");
...
__name45(RadioGroupItemProvider, "RadioGroupItemProvider");
var RadioGroupItemTrigger = React211.forwardRef(__name45(function RadioGroupItemTrigger2(props, forwardedRef) {
  ...
  React211.useEffect(() => {
    const handleKeyDown = __name45((event) => {
      if (ARROW_KEYS2.includes(event.key)) {
        isArrowKeyPressedRef.current = true;
      }
    }, "handleKeyDown");
    const handleKeyUp = __name45(() => isArrowKeyPressedRef.current = false, "handleKeyUp");
...
var RadioGroupItem = React211.forwardRef(
  __name45(function RadioGroupItem2(props, forwardedRef) {
...
var RadioGroupItemBubbleInput = React211.forwardRef(__name45(function RadioGroupItemBubbleInput2(props, forwardedRef) {
...
var RadioGroupIndicator = React211.forwardRef(
  // blank line to reduce diff noise
  __name45(function RadioGroupIndicator2(props, forwardedRef) {
...
var __name46 = (target, value) => __defProp46(target, "name", { value, configurable: true });
...
__name46(useStateMachine2, "useStateMachine");
var SCROLL_AREA_NAME = "ScrollArea";
var [createScrollAreaContext, createScrollAreaScope] = createContextScope(SCROLL_AREA_NAME);
var [ScrollAreaProvider, useScrollAreaContext] = createScrollAreaContext(SCROLL_AREA_NAME);
var ScrollArea = React212.forwardRef(
  __name46(function ScrollArea2(props, forwardedRef) {
    const {
      __scopeScrollArea,
      type = "hover",
      dir,
...
var ScrollAreaViewport = React212.forwardRef(
  // blank line to reduce diff noise
  __name46(function ScrollAreaViewport2(props, forwardedRef) {
...
var ScrollAreaViewportStyle = React212.memo(
  __name46(function ScrollAreaViewportStyle2({ nonce }) {
    return (0, import_jsx_runtime35.jsx)(
      "style",
      {
...
var ScrollAreaScrollbar = React212.forwardRef(
  // blank line to reduce diff noise
  __name46(function ScrollAreaScrollbar2(props, forwardedRef) {
...
var ScrollAreaScrollbarHover = React212.forwardRef(__name46(function ScrollAreaScrollbarHover2(props, forwardedRef) {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  ...
  React212.useEffect(() => {
    ...
    let hideTimer = 0;
    if (scrollArea) {
      const handlePointerEnter = __name46(() => {
        window.clearTimeout(hideTimer);
        setVisible(true);
      }, "handlePointerEnter");
      const handlePointerLeave = __name46(() => {
...
var ScrollAreaScrollbarScroll = React212.forwardRef(__name46(function ScrollAreaScrollbarScroll2(props, forwardedRef) {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarAuto = React212.forwardRef(__name46(function ScrollAreaScrollbarAuto2(props, forwardedRef) {
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const { forceMount, ...scrollbarProps } = props;
  const [visible, setVisible] = React212.useState(false);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarVisible = React212.forwardRef(__name46(function ScrollAreaScrollbarVisible2(props, forwardedRef) {
  ...
  const commonProps = {
    ...
    onThumbChange: __name46((thumb) => thumbRef.current = thumb, "onThumbChange"),
    onThumbPointerUp: __name46(() => pointerOffsetRef.current = 0, "onThumbPointerUp"),
    onThumbPointerDown: __name46((pointerPos) => pointerOffsetRef.current = pointerPos, "onThumbPointerDown")
  };
  function getScrollPosition(pointerPos, dir) {
    return getScrollPositionFromPointer(pointerPos, pointerOffsetRef.current, sizes, dir);
  }
  __name46(getScrollPosition, "getScrollPosition");
  if (orientation === "horizontal") {
    return (0, import_jsx_runtime35.jsx)(
...
var ScrollAreaScrollbarX = React212.forwardRef(__name46(function ScrollAreaScrollbarX2(props, forwardedRef) {
...
var ScrollAreaScrollbarY = React212.forwardRef(__name46(function ScrollAreaScrollbarY2(props, forwardedRef) {
  const { sizes, onSizesChange, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const [computedStyle, setComputedStyle] = React212.useState();
  const ref = React212.useRef(null);
...
var ScrollAreaScrollbarImpl = React212.forwardRef(__name46(function ScrollAreaScrollbarImpl2(props, forwardedRef) {
  const {
    __scopeScrollArea,
    sizes,
    hasThumb,
  ...
  __name46(handleDragScroll, "handleDragScroll");
  React212.useEffect(() => {
    const handleWheel = __name46((event) => {
...
var ScrollAreaThumb = React212.forwardRef(
  // blank line to reduce diff noise
  __name46(function ScrollAreaThumb2(props, forwardedRef) {
...
var ScrollAreaThumbImpl = React212.forwardRef(
  // blank line to reduce diff noise
  __name46(function ScrollAreaThumbImpl2(props, forwardedRef) {
...
var ScrollAreaCorner = React212.forwardRef(
  // blank line to reduce diff noise
  __name46(function ScrollAreaCorner2(props, forwardedRef) {
...
var ScrollAreaCornerImpl = React212.forwardRef(__name46(function ScrollAreaCornerImpl2(props, forwardedRef) {
...
__name46(toInt, "toInt");
function getThumbRatio(viewportSize, contentSize) {
  const ratio = viewportSize / contentSize;
  return isNaN(ratio) ? 0 : ratio;
}
__name46(getThumbRatio, "getThumbRatio");
...
__name46(getThumbSize, "getThumbSize");
...
__name46(getScrollPositionFromPointer, "getScrollPositionFromPointer");
...
__name46(getThumbOffsetFromScroll, "getThumbOffsetFromScroll");
...
__name46(linearScale, "linearScale");
function isScrollingWithinScrollbarBounds(scrollPos, maxScrollPos) {
  return scrollPos > 0 && scrollPos < maxScrollPos;
}
__name46(isScrollingWithinScrollbarBounds, "isScrollingWithinScrollbarBounds");
var addUnlinkedScrollListener = __name46((node, handler = () => {
}) => {
  let prevPosition = { left: node.scrollLeft, top: node.scrollTop };
  let rAF = 0;
  __name46(function loop() {
...
__name46(useDebounceCallback, "useDebounceCallback");
...
__name46(useResizeObserver2, "useResizeObserver");
...
var __name47 = (target, value) => __defProp47(target, "name", { value, configurable: true });
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React59.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React59.useCallback((option) => {
...
__name47(SelectProvider, "SelectProvider");
var Select = __name47((props) => {
...
var SelectTrigger = React59.forwardRef(
  __name47(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name47((pointerEvent) => {
      if (!isDisabled) {
        context.onOpenChange(true);
        resetTypeahead();
      }
...
var SelectValue = React59.forwardRef(
  __name47(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime36.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime36.jsx)(React59.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React59.forwardRef(
  __name47(function SelectIcon2(props, forwardedRef) {
...
var [PortalProvider5, usePortalContext5] = createSelectContext(PORTAL_NAME5, {
  forceMount: void 0
});
var SelectPortal = __name47((props) => {
...
var SelectContent = React59.forwardRef(
  __name47(function SelectContent2(props, forwardedRef) {
...
var SelectContentFragment = React59.forwardRef(__name47(function SelectContentFragment2(props, forwardedRef) {
...
var SelectContentImpl = React59.forwardRef(
  // blank line to reduce diff noise
  __name47(function SelectContentImpl2(props, forwardedRef) {
    ...
    React59.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name47((event) => {
          var _a2, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name47((event) => {
    ...
    React59.useEffect(() => {
      const close = __name47(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React59.forwardRef(__name47(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React59.forwardRef(__name47(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React59.forwardRef(
  __name47(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React59.forwardRef(
  __name47(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React59.forwardRef(
  __name47(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React59.forwardRef(
  __name47(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React59.forwardRef(
  __name47(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React59.forwardRef(
  // blank line to reduce diff noise
  __name47(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React59.forwardRef(__name47(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name47(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React59.forwardRef(__name47(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React59.forwardRef(__name47(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React59.forwardRef(
  // blank line to reduce diff noise
  __name47(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React59.forwardRef(
  __name47(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope4(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME2, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime36.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React59.forwardRef(
  // blank line to reduce diff noise
  __name47(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
...
__name47(isFunction4, "isFunction");
function shouldShowPlaceholder(value) {
  return value === "" || value === void 0;
}
__name47(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React59.useCallback(
    (key) => {
      ...
      __name47(function updateSearch(value) {
        searchRef.current = value;
        window.clearTimeout(timerRef.current);
        if (value !== "") timerRef.current = window.setTimeout(() => updateSearch(""), 1e3);
      }, "updateSearch")(search);
...
__name47(useTypeaheadSearch, "useTypeaheadSearch");
...
__name47(findNextItem, "findNextItem");
function wrapArray4(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name47(wrapArray4, "wrapArray");
...
var __name48 = (target, value) => __defProp48(target, "name", { value, configurable: true });
var DEFAULT_ORIENTATION = "horizontal";
var ORIENTATIONS = ["horizontal", "vertical"];
var Separator3 = React60.forwardRef(
  __name48(function Separator24(props, forwardedRef) {
...
__name48(isValidOrientation, "isValidOrientation");
...
var __name49 = (target, value) => __defProp49(target, "name", { value, configurable: true });
...
var Slider = React61.forwardRef(
  // blank line to reduce diff noise
  __name49(function Slider2(props, forwardedRef) {
    const {
      name,
      min: min2 = 0,
      max: max2 = 100,
      ...
      defaultValue = [min2],
      value,
      onValueChange = __name49(() => {
      }, "onValueChange"),
      onValueCommit = __name49(() => {
      }, "onValueCommit"),
      inverted = false,
      form,
      ...sliderProps
    ...
    const isKeyboardInteractionRef = React61.useRef(false);
    const isHorizontal = orientation === "horizontal";
    const SliderOrientation = isHorizontal ? SliderHorizontal : SliderVertical;
    const [control, setControl] = React61.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, setControl);
    const [values = [], setValues] = useControllableState({
      prop: value,
      defaultProp: defaultValue,
      onChange: __name49((value2) => {
        var _a2;
    ...
    const initialValuesRef = React61.useRef(values);
    React61.useEffect(() => {
      const associatedForm = form ? control == null ? void 0 : control.ownerDocument.getElementById(form) : control == null ? void 0 : control.closest("form");
      if (associatedForm instanceof HTMLFormElement) {
        const reset = __name49(() => setValues(initialValuesRef.current), "reset");
        associatedForm.addEventListener("reset", reset);
        return () => associatedForm.removeEventListener("reset", reset);
      }
    ...
    __name49(handleSlideStart, "handleSlideStart");
    function handleSlideMove(value2) {
      updateValues(value2, valueIndexToChangeRef.current);
    }
    __name49(handleSlideMove, "handleSlideMove");
    function handleSlideEnd() {
      const hasChanged = String(values) !== String(valuesBeforeSlideStartRef.current);
      if (hasChanged) onValueCommit(values);
    }
    __name49(handleSlideEnd, "handleSlideEnd");
    ...
    __name49(updateValues, "updateValues");
...
var SliderHorizontal = React61.forwardRef(
  // blank line to reduce diff noise
  __name49(function SliderHorizontal2(props, forwardedRef) {
    const {
      min: min2,
      max: max2,
      dir,
    ...
    __name49(getValueFromPointer, "getValueFromPointer");
    return (0, import_jsx_runtime38.jsx)(
...
var SliderVertical = React61.forwardRef(
  __name49(function SliderVertical2(props, forwardedRef) {
    const {
      min: min2,
      max: max2,
      inverted,
...
var SliderImpl = React61.forwardRef(
  __name49(function SliderImpl2(props, forwardedRef) {
    const {
      __scopeSlider,
      onSlideStart,
      onSlideMove,
...
var SliderTrack = React61.forwardRef(
  __name49(function SliderTrack2(props, forwardedRef) {
...
var SliderRange = React61.forwardRef(
  __name49(function SliderRange2(props, forwardedRef) {
...
__name49(SliderThumbProvider, "SliderThumbProvider");
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React61.forwardRef(
  // blank line to reduce diff noise
  __name49(function SliderThumbTrigger2(props, forwardedRef) {
...
var SliderThumb = React61.forwardRef(
  __name49(function SliderThumb2(props, forwardedRef) {
...
var SliderBubbleInput = React61.forwardRef(
  // blank line to reduce diff noise
  __name49(function SliderBubbleInput2({ __scopeSlider, ...props }, forwardedRef) {
...
__name49(getNextSortedValues, "getNextSortedValues");
...
__name49(convertValueToPercentage, "convertValueToPercentage");
...
__name49(getClosestValueIndex, "getClosestValueIndex");
...
__name49(getThumbInBoundsOffset, "getThumbInBoundsOffset");
function getStepsBetweenValues(values) {
  return values.slice(0, -1).map((value, index2) => values[index2 + 1] - value);
}
__name49(getStepsBetweenValues, "getStepsBetweenValues");
...
__name49(hasMinStepsBetweenValues, "hasMinStepsBetweenValues");
...
__name49(linearScale2, "linearScale");
...
__name49(getDecimalCount, "getDecimalCount");
function roundValue(value, decimalCount) {
  const rounder = Math.pow(10, decimalCount);
  return Math.round(value * rounder) / rounder;
}
__name49(roundValue, "roundValue");
...
__name49(getNextStepValue, "getNextStepValue");
function isFunction5(value) {
  return typeof value === "function";
}
__name49(isFunction5, "isFunction");
...
var __name50 = (target, value) => __defProp50(target, "name", { value, configurable: true });
...
function SwitchProvider(props) {
  ...
  const [control, setControl] = React62.useState(null);
  const [bubbleInput, setBubbleInput] = React62.useState(null);
  const hasConsumerStoppedPropagationRef = React62.useRef(false);
  const [userInteractionCount, onUserInteraction] = React62.useReducer(
    (count3) => count3 + 1,
    0
  );
  const isFormControl2 = control ? !!form || !!control.closest("form") : (
...
__name50(SwitchProvider, "SwitchProvider");
var TRIGGER_NAME13 = "SwitchTrigger";
var SwitchTrigger = React62.forwardRef(
  __name50(function SwitchTrigger2({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) {
    const {
      control,
      form,
      value,
...
var Switch = React62.forwardRef(
  // blank line to reduce diff noise
  __name50(function Switch2(props, forwardedRef) {
    const {
      __scopeSwitch,
      name,
      checked,
...
var SwitchThumb = React62.forwardRef(
  __name50(function SwitchThumb2(props, forwardedRef) {
...
var SwitchBubbleInput = React62.forwardRef(
  // blank line to reduce diff noise
  __name50(function SwitchBubbleInput2({ __scopeSwitch, onClick, ...props }, forwardedRef) {
    const {
      control,
      hasConsumerStoppedPropagationRef,
      userInteractionCount,
    ...
    const composedRefs = useComposedRefs(forwardedRef, setBubbleInput);
    const controlSize = useSize(control);
    const shouldStopClickPropagationRef = React62.useRef(false);
    const prevCheckedRef = React62.useRef(checked);
    const prevUserInteractionCountRef = React62.useRef(userInteractionCount);
    React62.useEffect(() => {
      const input = bubbleInput;
      if (!input) return;
      const inputProto = window.HTMLInputElement.prototype;
    ...
    const defaultCheckedRef = React62.useRef(checked);
    return (0, import_jsx_runtime39.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
__name50(isFunction6, "isFunction");
function getState7(checked) {
  return checked ? "checked" : "unchecked";
}
__name50(getState7, "getState");
...
var __name51 = (target, value) => __defProp51(target, "name", { value, configurable: true });
var TABS_NAME = "Tabs";
...
var Tabs = React63.forwardRef(
  // blank line to reduce diff noise
  __name51(function Tabs2(props, forwardedRef) {
    const {
      __scopeTabs,
      value: valueProp,
      onValueChange,
...
var TabsList = React63.forwardRef(
  // blank line to reduce diff noise
  __name51(function TabsList2(props, forwardedRef) {
...
var TabsTrigger = React63.forwardRef(
  __name51(function TabsTrigger2(props, forwardedRef) {
...
var TabsContent = React63.forwardRef(
  __name51(function TabsContent2(props, forwardedRef) {
...
__name51(makeTriggerId2, "makeTriggerId");
function makeContentId2(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name51(makeContentId2, "makeContentId");
var Root211 = Tabs;
var List2 = TabsList;
...
var __name52 = (target, value) => __defProp52(target, "name", { value, configurable: true });
...
var ToastProvider = __name52((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React64.forwardRef(
  __name52(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React64.useEffect(() => {
      const handleKeyDown = __name52((event) => {
        var _a2;
    ...
    React64.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name52((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name52(() => {
...
var FocusProxy = React64.forwardRef(
  // blank line to reduce diff noise
  __name52(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React64.forwardRef(
  // blank line to reduce diff noise
  __name52(function Toast2(props, forwardedRef) {
...
var ToastImpl = React64.forwardRef(
  __name52(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
...
var ToastAnnounce = __name52((props) => {
...
var ToastTitle = React64.forwardRef(
  __name52(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React64.forwardRef(
  // blank line to reduce diff noise
  __name52(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React64.forwardRef(
  __name52(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React64.forwardRef(
  __name52(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React64.forwardRef(__name52(function ToastAnnounceExclude2(props, forwardedRef) {
...
__name52(getAnnounceTextContent, "getAnnounceTextContent");
...
__name52(handleAndDispatchCustomEvent2, "handleAndDispatchCustomEvent");
var isDeltaInDirection = __name52((delta, direction, threshold = 0) => {
...
__name52(useNextFrame, "useNextFrame");
function isHTMLElement3(node) {
  return node.nodeType === node.ELEMENT_NODE;
}
__name52(isHTMLElement3, "isHTMLElement");
function getTabbableCandidates3(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name52((node) => {
      const isHiddenInput = node.tagName === "INPUT" && node.type === "hidden";
      if (node.disabled || node.hidden || isHiddenInput) return NodeFilter.FILTER_SKIP;
      return node.tabIndex >= 0 ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
    }, "acceptNode")
...
__name52(getTabbableCandidates3, "getTabbableCandidates");
...
__name52(focusFirst5, "focusFirst");
...
var __name53 = (target, value) => __defProp53(target, "name", { value, configurable: true });
var NAME = "Toggle";
var Toggle = React65.forwardRef(
  __name53(function Toggle2(props, forwardedRef) {
...
var __name54 = (target, value) => __defProp54(target, "name", { value, configurable: true });
var TOGGLE_GROUP_NAME = "ToggleGroup";
var [createToggleGroupContext, createToggleGroupScope] = createContextScope(TOGGLE_GROUP_NAME, [
  createRovingFocusGroupScope
]);
var useRovingFocusGroupScope6 = createRovingFocusGroupScope();
var ToggleGroup = React66.forwardRef(__name54(function ToggleGroup2(props, forwardedRef) {
...
var ToggleGroupImplSingle = React66.forwardRef(__name54(function ToggleGroupImplSingle2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name54(() => {
    }, "onValueChange"),
  ...
  return (0, import_jsx_runtime43.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      type: "single",
      value: React66.useMemo(() => value ? [value] : [], [value]),
      onItemActivate: setValue,
      onItemDeactivate: React66.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime43.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
}, "ToggleGroupImplSingle"));
var ToggleGroupImplMultiple = React66.forwardRef(__name54(function ToggleGroupImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name54(() => {
  ...
  const handleButtonActivate = React66.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React66.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime43.jsx)(
...
var ToggleGroupImpl = React66.forwardRef(
  // blank line to reduce diff noise
  __name54(function ToggleGroupImpl2(props, forwardedRef) {
    const {
      __scopeToggleGroup,
      disabled = false,
      rovingFocus = true,
...
var ToggleGroupItem = React66.forwardRef(
  // blank line to reduce diff noise
  __name54(function ToggleGroupItem2(props, forwardedRef) {
...
var ToggleGroupItemImpl = React66.forwardRef(
  // blank line to reduce diff noise
  __name54(function ToggleGroupItemImpl2(props, forwardedRef) {
...
var __name55 = (target, value) => __defProp55(target, "name", { value, configurable: true });
...
var Toolbar = React67.forwardRef(
  // blank line to reduce diff noise
  __name55(function Toolbar2(props, forwardedRef) {
...
var ToolbarSeparator = React67.forwardRef(
  // blank line to reduce diff noise
  __name55(function ToolbarSeparator2(props, forwardedRef) {
...
var ToolbarButton = React67.forwardRef(
  __name55(function ToolbarButton2(props, forwardedRef) {
...
var ToolbarLink = React67.forwardRef(
  __name55(function ToolbarLink2(props, forwardedRef) {
...
var ToolbarToggleGroup = React67.forwardRef(
  // blank line to reduce diff noise
  __name55(function ToolbarToggleGroup2(props, forwardedRef) {
...
var ToolbarToggleItem = React67.forwardRef(
  // blank line to reduce diff noise
  __name55(function ToolbarToggleItem2(props, forwardedRef) {
...
var ToggleGroup3 = ToolbarToggleGroup;
...
var __name56 = (target, value) => __defProp56(target, "name", { value, configurable: true });
...
var TooltipProvider = __name56((props) => {
  const {
    __scopeTooltip,
...
var Tooltip = __name56((props) => {
  ...
  const [contentIdState, setContentId] = React68.useState(void 0);
...
var TooltipTrigger = React68.forwardRef(
  __name56(function TooltipTrigger2(props, forwardedRef) {
...
var [PortalProvider6, usePortalContext6] = createTooltipContext(PORTAL_NAME6, {
  forceMount: void 0
});
var TooltipPortal = __name56((props) => {
...
var TooltipContent = React68.forwardRef(
  __name56(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React68.forwardRef(__name56(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  ...
  React68.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name56((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name56((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React68.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name56((event) => {
        const target = event.target;
...
var TooltipContentImpl = React68.forwardRef(
  // blank line to reduce diff noise
  __name56(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
      "aria-label": ariaLabel,
    ...
    React68.useEffect(() => {
      if (context.trigger) {
        const handleScroll2 = __name56((event) => {
        ...
        children: (0, import_jsx_runtime45.jsxs)(
          Content3,
          {
            ...
            children: [
              ...
              ariaLabel ? (0, import_jsx_runtime45.jsx)(Root2, { id: context.contentId, role: "tooltip", children: ariaLabel }) : null
            ]
          }
        )
      }
...
var TooltipArrow = React68.forwardRef(
  __name56(function TooltipArrow2(props, forwardedRef) {
    const { __scopeTooltip, ...arrowProps } = props;
    const popperScope = usePopperScope5(__scopeTooltip);
    return (0, import_jsx_runtime45.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "TooltipArrow")
);
...
__name56(getExitSideFromRect, "getExitSideFromRect");
...
__name56(getPaddedExitPoints, "getPaddedExitPoints");
...
__name56(getPointsFromRect, "getPointsFromRect");
...
__name56(isPointInPolygon2, "isPointInPolygon");
...
__name56(getHullPresorted, "getHullPresorted");
