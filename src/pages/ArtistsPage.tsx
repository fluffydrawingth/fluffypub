      ...
      <div style={{ background:`linear-gradient(135deg,${theme.bgColor},${theme.bgColor2})`, padding:'48px 24px 40px', textAlign:'center' }}>
        <div style={{ fontSize:56, marginBottom:8, lineHeight:1 }}>
          {theme.labels?.artists_header_img
            ? <img src={theme.labels.artists_header_img} alt="" style={{ width:64, height:64, objectFit:'cover', borderRadius:14, display:'inline-block', verticalAlign:'middle' }} />
            : (theme.labels?.artists_page_emoji ?? '🎨')}
        </div>
        <h1 style={{ fontSize:42, fontWeight:900, color:theme.textColor, margin:'0 0 12px' }}>
          {theme.labels?.artists_page_title ?? 'Our Artists'}
        </h1>
