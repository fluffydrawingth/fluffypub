      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 16px 60px' }}>
        ...
        <div style={{ background: 'white', borderRadius: 20, padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: `1.5px solid ${p}12`, display: 'flex', gap: 18, alignItems: 'center', flexWrap: 'wrap', marginBottom: 24 }}>
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            <div style={{ fontSize: 12.5, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.5 }}>{tRaw('หนังสือจากชุมชน', 'Community Book')}</div>
            <h1 style={{ fontSize: 30, fontWeight: 900, color: '#1e293b', margin: '2px 0 4px' }}>{book.title}</h1>
            {book.author && <p style={{ fontSize: 16, color: '#64748b', margin: 0 }}>by {book.author}</p>}
          </div>
