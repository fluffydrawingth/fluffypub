...
module.exports = async function handler(req, res) {
  ...
  if (req.method === 'PUT' && id) {
    ...
    if (user.role === 'admin') allowed.push('featured','bestseller','is_new','digital_download_url','download_instruction','artist_id','artist_name','r2_key','r2_file_name','file_size','file_type','artist_physical_royalty_thb','digital_platform_fee_thb','digital_platform_fee_usd','digital_artist_royalty_percent');
